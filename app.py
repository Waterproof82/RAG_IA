...
def create_agent(api_key=None, model_name="models/gemini-2.5-flash", temperature=0.7):
...
def main():
    ...
    parser.add_argument("--model", default="models/gemini-2.5-flash", help="Gemini model to use")
